...
What if I told you that you could run a 3 node, 6 core, GKE cluster at over a 80% discount, as low as $25 per month? In this Git repository, you can use Terraform to deploy a GKE cluster with all of the cost savings maneuvers in place to get you up and running with GKE on the cheap.
